...
if (!Object.getOwnPropertyDescriptor(Module, "aesManager")) Module["aesManager"] = function() {
 abort("'aesManager' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
};
