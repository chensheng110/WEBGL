...
const managerConfig = {
    DATA_FILE_MD5: 'cc46d187e6138a7b',
    CODE_FILE_MD5: '32b10a91a71566ca',
    GAME_NAME: 'webgl',
    APPID: 'wx493d4258c72c06ef',
    DATA_FILE_SIZE: '23996761',
    OPT_DATA_FILE_SIZE: '$OPT_DATA_FILE_SIZE',
    DATA_CDN: 'https://xywdz.oss-cn-beijing.aliyuncs.com/webgl/',
    // 资源包是否作为小游戏分包加载
        ...
        Object.assign(managerConfig, {
            ...
            loadingPageConfig: {
                ...
                materialConfig: {
                    ...
                    backgroundImage: 'images/选择角色背景.png',
                    backgroundVideo: '',
